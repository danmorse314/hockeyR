...
You can install the development version of `hockeyR` from [GitHub](https://github.com/) with:
...
There are a few functions also included that will scrape data from [hockey-reference.com](https://hockey-reference.com).
